...
const Settings = () => {
  ...
  const handleLogoutSession = (id) => {
    ...
    setSessionMessage("Session logged out successfully.");
    setTimeout(() => {
      setSessionMessage("");
    }, 2500);
  };
    ...
    <>
      <div className="settings-page">
        <div className="settings-header">
          <div>
            <h1>Settings</h1>
            <p>Manage your Account, WhatsApp and Security Settings</p>
          </div>
        </div>
        ...
        {!activeSetting && (
          <div className="settings-options">
            ...
            >
              <div className="option-left">
                <div className="option-icon security-icon">🔐</div>
